...
int main() {
    // Example vertices of a planar graph
    ...
    std::vector<std::vector<size_t>> adj = {
        {1, 3},  // Adjacent to vertices 1 and 3
        {0, 2},  // Adjacent to vertices 0 and 2
        {1, 3},  // Adjacent to vertices 1 and 3
        {0, 2}   // Adjacent to vertices 0 and 2
    };

    // Find and print faces
    std::vector<std::vector<size_t>> faces = find_faces(vertices, adj);
